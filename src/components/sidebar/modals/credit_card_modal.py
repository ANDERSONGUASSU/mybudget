...
from src.components.sidebar.modals.new_credit_card_modal import get_new_credit_card_modal
                ...
                dbc.Col([
                    ...
                    dbc.InputGroup([
                        dbc.Select(
                            ...
                            options=[
                                {"label": f"{i}x", "value": i} for i in range(1, 25)
                            ],
                            value=1
                        ),
